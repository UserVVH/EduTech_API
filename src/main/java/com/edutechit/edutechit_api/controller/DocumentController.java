...
public class DocumentController {
  ...
  public ResponseEntity<DocumentDto> createDocument(
      @Valid @ModelAttribute DocumentCreateDto documentCreateDTO,
  ...
  public ResponseEntity<DocumentDto> getDocument(@PathVariable Long id) {
    return ResponseEntity.ok(documentService.getDocument(
        id)); // Trả về thông tin của document có id trùng với id truyền vào
  ...
  public ResponseEntity<List<DocumentResponseDto>> getAllDocuments() {
    return ResponseEntity.ok(
        documentService.getAllDocuments()); // Trả về danh sách tất cả các document
  }

  // Cập nhật document
  @PutMapping("/{id}")
  public ResponseEntity<DocumentDto> updateDocument(@PathVariable Long id,
      @ModelAttribute DocumentCreateDto documentCreateDTO,
      @RequestHeader("Authorization") String token) {
  ...
  public ResponseEntity<List<DocumentResponseDto>> getDocumentsByCategoryName(
  ...
  public ResponseEntity<List<DocumentResponseDto>> getDocumentsByUserIdAndVERIFIED(
  ...
  public ResponseEntity<List<DocumentResponseDto>> getDocumentsByUserIdAndCREATED(
      @PathVariable Long userId) {
  ...
  public ResponseEntity<List<DocumentResponseDto>> getDocumentsOfMyAndVERIFIED(
      @RequestHeader("Authorization") String token) {
  ...
  public ResponseEntity<List<DocumentResponseDto>> getDocumentsOfMyAndCREATED(
      @RequestHeader("Authorization") String token) {
  ...
  public ResponseEntity<List<DocumentResponseDto>> getDocumentsOfMyAndREJECTED(
      @RequestHeader("Authorization") String token) {
  ...
  @GetMapping("/my")
  public ResponseEntity<List<DocumentResponseDto>> getAllDocumentsOfMy(
      @RequestHeader("Authorization") String token) {
  ...
  @GetMapping("/search")
  public ResponseEntity<List<DocumentResponseDto>> searchDocumentsByTitle(
