  ...
  public ResponseEntity<?> unsubscribe(@RequestParam String email) {
    ...
    return ResponseEntity.ok()
        ...
        .body("<!DOCTYPE html>" +
            ...
            +
            "h1 { color: #007BFF; }" + // Changed to blue
            "p { color: #555; }" +
            ".button { margin-top: 20px; padding: 10px 20px; color: white; background-color: #007BFF; border: none; border-radius: 5px; text-decoration: none; font-weight: bold; }"
            + // Changed to blue
